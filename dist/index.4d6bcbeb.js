...
})({"iB9h6":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
},{"./reset.css":"8XPx9","./app1.js":"gMhIk","./global.css":"11axS","./app2.js":"alK4Z","./app3.js":"264pe","./app4.js":"6ZENx"}],"8XPx9":[function() {},{}],"gMhIk":[function(require,module,exports) {
...
const $numbers = _jqueryDefault.default('#numbers');
const n = localStorage.getItem('n');
$numbers.text(n || 0);
$add1.on('click', ()=>{
    let n1 = parseInt($numbers.text());
    n1 += 1;
    localStorage.setItem('n', n1);
    $numbers.text(n1);
});
$minus1.on('click', ()=>{
    let n2 = parseInt($numbers.text());
    n2 -= 1;
    localStorage.setItem('n', n2);
    $numbers.text(n2);
});
$mul2.on('click', ()=>{
    let n3 = parseInt($numbers.text());
    n3 *= 2;
    localStorage.setItem('n', n3);
    $numbers.text(n3);
});
$divide2.on('click', ()=>{
    let n4 = parseInt($numbers.text());
    n4 /= 2;
    localStorage.setItem('n', n4);
    $numbers.text(n4);
});

},{"./app1.css":"7FkZd","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"kQkBp"}],"7FkZd":[function() {},{}],"hgMhh":[function(require,module,exports) {
/*!
 ...
 */ jQuery.event = {
    ...
    var whitespace1 = "[\\x20\\t\\r\\n\\f]";
    var rtrimCSS = new RegExp("^" + whitespace1 + "+|((?:^|[^\\\\])(?:\\\\.)*)" + whitespace1 + "+$", "g");
    (function() {
 ...
 */ jQuery.fn.load = function(url, params, callback) {
    ...
    var rtrim1 = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;
    ...
    jQuery.trim = function(text) {
        return text == null ? "" : (text + "").replace(rtrim1, "$1");
    };
...
},{}],"kQkBp":[function(require,module,exports) {
...
},{}],"11axS":[function() {},{}],"alK4Z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _app2Css = require("./app2.css");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const $tabBar = _jqueryDefault.default('.tabBar');
const $tabContent = _jqueryDefault.default('.tabContent');
...
},{"./app2.css":"8RnuD","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"kQkBp"}],"8RnuD":[function() {},{}],"264pe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./app3.css":"iOgrn","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"kQkBp"}],"iOgrn":[function() {},{}],"6ZENx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _app4Css = require("./app4.css");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const $circle = _jqueryDefault.default('.circle');
...
},{"./app4.css":"jZ1KW","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"kQkBp"}],"jZ1KW":[function() {},{}]},["iB9h6","gLLPy"], "gLLPy", "parcelRequiree44b")
